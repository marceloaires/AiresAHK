...
sleep 5 
 ...
 ;waiting while Windows does this. Just in case it takes longer than 0 milliseconds.
...
ControlGetPos, 40, 128, 168, 15, Edit2, ahk_class Premiere Pro, SubWindow, SubWindow 
...
^+q::preset("BAIXO IN")
^+w::preset("CIMA IN")
^+e::preset("ESQUERDA IN")
^+r::preset("DIREITA IN")
^+t::preset("BAIXO OUT")
^+y::preset("BLUR HQ")
^+u::preset("Gaussian Blur Preset")
^+i::preset("Horizontal Flip Preset")
^+o::preset("Vertical Flip Preset")
^+p::preset("Lumetri Collor Preset")
^+´::preset("Ultra Key Preset")
^+[::preset("Auto Reframe Preset")
^+a::preset("Crop Preset")
^+s::preset("Warp Stabilizer Preset")
^+d::preset("Dip to Black")
